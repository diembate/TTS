...
public class OrderDetailInfoResourceIT {
    ...
    public void createOrderDetailInfo() throws Exception {
        ...
        OrderDetailInfoDTO orderDetailInfoDTO = orderDetailInfoMapper.toDto(orderDetailInfo);
        restOrderDetailInfoMockMvc.perform(post("/api/order-detail-infos")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(orderDetailInfoDTO)))
    ...
    public void updateOrderDetailInfo() throws Exception {
        ...
        updatedOrderDetailInfo
            ...
            .amount(UPDATED_AMOUNT)
            .orderDate(UPDATED_ORDER_DATE);
        OrderDetailInfoDTO orderDetailInfoDTO = orderDetailInfoMapper.toDto(updatedOrderDetailInfo);

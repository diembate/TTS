...
public class ImportInfoResourceIT {
    ...
    public void createImportInfo() throws Exception {
        ...
        ImportInfoDTO importInfoDTO = importInfoMapper.toDto(importInfo);
        restImportInfoMockMvc.perform(post("/api/import-infos")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(importInfoDTO)))
    ...
    public void updateImportInfo() throws Exception {
        ...
        updatedImportInfo
            ...
            .supplier(UPDATED_SUPPLIER)
            .cost(UPDATED_COST);
        ImportInfoDTO importInfoDTO = importInfoMapper.toDto(updatedImportInfo);
